...
export declare function checkStandardSectionsDetected(parsedResume: ParsedResume, profile: ResumeTypeProfile): RuleResult;
...
export declare function runStructureRules(parsedResume: ParsedResume, profile: ResumeTypeProfile): RuleResult[];
